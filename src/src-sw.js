...
self.addEventListener('push', event => {
  ...
  // Send the data payload to the client app
  // self.clients.matchAll().then(clients => {
  //   clients.forEach(client => {
  //     client.postMessage('push-notification is working!');
  //   });
  // });
  // Send the data payload to the client app using the BroadcastChannel API
